...
class VoitureController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('admin/voiture/index.html.twig', array(
            'voitures' => $voitures,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('admin/voiture/new.html.twig', array(
            'voiture' => $voiture,
    ...
    public function showAction(Voiture $voiture)
    {
        ...
        return $this->render('admin/voiture/show.html.twig', array(
            'voiture' => $voiture,
    ...
    public function editAction(Request $request, Voiture $voiture)
    {
        ...
        return $this->render('admin/voiture/edit.html.twig', array(
            'voiture' => $voiture,
